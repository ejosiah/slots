...
public class Query {
	...
	private Query(Integer id, List<List<Symbol>> symbols, Integer line, Integer numberOfCoins, BigDecimal wildMultiplier){
		this.id = id;
	...
	public static Query with(List<List<Symbol>> symbols, Integer line, Integer numberOfCoins, BigDecimal wildMultiplier){
